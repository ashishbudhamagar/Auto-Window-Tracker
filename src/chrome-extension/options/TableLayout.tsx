...
export default function TableLayout(
  ...
  const handleUntrackAndActiveWindow = (windowName: string) => {
    const newLength = arrayOfTrackedWindowValues.length - 1;
    if (activeWindow >= newLength) {
      setActiveWindow(Math.max(0, newLength - 1));
    }
          ...
          <div className="px-8 py-6 flex justify-between items-center border-b border-gray-200/50 dark:border-gray-600/50 bg-gradient-to-r from-white/80 to-blue-50/80 dark:from-gray-800/80 dark:to-gray-700/80 backdrop-blur-sm sticky top-0 z-10">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button 
                ...
                onClick={() => handleUntrackAndActiveWindow(arrayOfTrackedWindowValues[activeWindow].windowName)}
